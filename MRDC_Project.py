...
file_path_upload = '/Users/emiltonsoosaippillai/desktop/multinational-retail-data-centralisation/Local_database.yaml'
...
db_connector.upload_to_db(file_path_upload, cleaned_user_data_df, 'dim_users')
...
db_connector.upload_to_db(file_path_upload, cleaned_card_data, 'dim_card_details')
...
db_connector.upload_to_db(file_path_upload, cleaned_stores_df, 'dim_store_details')
...
final_cleaned_df = db_cleaning.clean_products_data(cleaned_products_df)
...
db_connector.upload_to_db(file_path_upload, final_cleaned_df, 'dim_products')
...
print(cleaned_date_events_table_df)

# Upload cleaned date events details data to the database
db_connector.upload_to_db(file_path_upload, cleaned_date_events_table_df, 'dim_date_times')
